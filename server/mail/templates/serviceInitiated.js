const serviceInitiated = (service, status, date, startTime, endTime) => {
	return `<!DOCTYPE html>
	<html>
	...
	<body>
		<div class="container">
			...
			<div class="body">
				<p>Dear User,</p>
				<p>We wanted to inform you that the status of your service <span class="highlight">${service}</span> has been updated. The current status is:</p>
				<h2 class="highlight">${status}</h2>
...
module.exports = serviceInitiated;
